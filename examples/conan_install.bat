...
REM Using debug_x64
set arg=--build missing -s build_type=Debug -s arch=x86_64 -s compiler.runtime=MDd
...
set lua_cpp_bin=%conandata%\lua-cpp\5.3.4\jinq0123\testing\package\c83d8b197f1a331ca3b55943846d427ad4f7f8e1\bin
...
set grpc_lua_dll=%conandata%\grpc-lua\0.1\jinq0123\testing\package\9081c368755c2f201c52a7a4fca3379da109d70f\bin\grpc_lua.dll
